...
#RUN sed -i '71 a <Connector port="8484" protocol="HTTP/1.1" maxThreads="150" SSlEnabled="false" scheme="http" secure="false" clientAuth="false" redirectPort="8484"/>' ${CATALINA_HOME}/conf/server.xml
