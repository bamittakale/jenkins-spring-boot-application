...
RUN sed -i '71 a <Connector port="8484" protocol="HTTP/1.1" maxThreads="150" SSlEnabled="false" clientAuth="false" />' ${CATALINA_HOME}/conf/server.xml
RUN sed -i 's/redirectPort="8080"/redirectPort="8484"/' ${CATALINA_HOME}/conf/server.xml
